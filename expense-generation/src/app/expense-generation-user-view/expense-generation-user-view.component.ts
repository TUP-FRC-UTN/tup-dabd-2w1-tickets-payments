...
@Component({
  ...
  standalone: true,
  imports: [ExpenseGenerationHeaderComponent, CommonModule, FormsModule, ExpenseGenerationCardComponent,RouterOutlet],
...
export class ExpenseGenerationUserViewComponent implements OnInit {
  ...
  realizarPagoIndividual(expense: ExpenseGenerationExpenseInterface) {
    ...
    const amount = typeof expense.actual_amount === 'string' 
